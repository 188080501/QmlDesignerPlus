    ...
    m_enableGradientEditing(true)
{
    ...
    connect(ui->spinBoxForRadius, (void(QSpinBox::*)(int))&QSpinBox::valueChanged,
            this, &ContextPaneWidgetRectangle::onRadiusChanged);
}
...
void ContextPaneWidgetRectangle::setProperties(QmlJS::PropertyReader *propertyReader)
{
    ...
    if (propertyReader->hasProperty(QLatin1String("radius"))) {
        ui->spinBoxForRadius->setValue(propertyReader->readProperty(QLatin1String("radius")).toInt());
    } else {
        ui->spinBoxForRadius->setValue(0);
    }
...
void ContextPaneWidgetRectangle::onRadiusChanged(int value)
{
    emit propertyChanged(QLatin1String("radius"), value);
}
