...
#ifdef UseHelperWidgetPlus // HelperWidgetPlus

#include "HelperWidgetPlus/HelperWidgetPlusForItem.h"

#endif                     // HelperWidgetPlus
...
ContextPaneWidget::ContextPaneWidget(QWidget *parent) : DragWidget(parent), m_currentWidget(0)
{
    ...
    layout->addWidget(m_helperWidgetPlusForItem);
...
void ContextPaneWidget::setProperties(::QmlJS::PropertyReader *propertyReader)
{
    ...
    HelperWidgetPlusForItem *helperWidgetPlusForItem = qobject_cast<HelperWidgetPlusForItem*>(m_currentWidget);
    if (helperWidgetPlusForItem)
        helperWidgetPlusForItem->setProperties(propertyReader);
...
bool ContextPaneWidget::setType(const QStringList &types)
{
    ...
    m_helperWidgetPlusForItem->hide();
    ...
    if (types.contains(QLatin1String("Item"))) {
        m_currentWidget = m_helperWidgetPlusForItem;
        m_helperWidgetPlusForItem->show();
        resize(sizeHint());
        return true;
    }
...
void ContextPaneWidget::createHelperWidgetPlusForItem()
{
    m_helperWidgetPlusForItem = new HelperWidgetPlusForItem(this);

    connect(m_helperWidgetPlusForItem, &HelperWidgetPlusForItem::propertyChanged,
            this, &ContextPaneWidget::propertyChanged);
    connect(m_helperWidgetPlusForItem, &HelperWidgetPlusForItem::removeProperty,
            this, &ContextPaneWidget::removeProperty);
    connect(m_helperWidgetPlusForItem, &HelperWidgetPlusForItem::removeAndChangeProperty,
            this, &ContextPaneWidget::removeAndChangeProperty);
}
