    ...
    ui(new Ui::EasingContextPane)
{
    ...
    connect(ui->comboBoxForProperty, (void(QComboBox::*)(const QString &))&QComboBox::currentIndexChanged,
            this, &EasingContextPane::on_propertyComboBox_currentIndexChanged);
}
...
void EasingContextPane::setProperties(QmlJS::PropertyReader *propertyReader)
{
    ...
    if (propertyReader->hasProperty(QLatin1String("property"))) {
        ui->comboBoxForProperty->setCurrentText(propertyReader->readProperty(QLatin1String("property")).toString());
    }
    else
    {
        ui->comboBoxForProperty->setCurrentText(QLatin1String(""));
    }
}
...
void QmlEditorWidgets::EasingContextPane::on_propertyComboBox_currentIndexChanged(QString property)
{
    if(property.isEmpty())
    {
        emit removeProperty(QLatin1String("property"));
    }
    else
    {
        emit propertyChanged(QLatin1String("property"), QLatin1String("\"") + property + QLatin1String("\""));
    }
}
